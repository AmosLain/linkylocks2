    ...
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-blue-50 to-indigo-100 dark:from-slate-900 dark:to-slate-800">
      ...
      <div className="container mx-auto px-4 py-20 text-center">
        ...
        <div className="flex justify-center gap-4 mb-16">
          ...
          <Link
            href="/pricing"
            className="px-8 py-4 bg-white dark:bg-slate-800 text-indigo-600 dark:text-indigo-400 rounded-lg text-lg font-semibold border-2 border-indigo-600 dark:border-indigo-400 hover:bg-indigo-50 dark:hover:bg-slate-700"
          >
            View Pricing
          </Link>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-4xl mx-auto">
          <div className="bg-white dark:bg-slate-800 p-6 rounded-xl shadow-lg">
            ...
            <h3 className="text-xl font-semibold mb-2 dark:text-white">Time-Based Expiry</h3>
            <p className="text-gray-600 dark:text-slate-400">
              Set links to expire after a specific date and time.
            </p>
          </div>
          <div className="bg-white dark:bg-slate-800 p-6 rounded-xl shadow-lg">
            <Eye className="w-12 h-12 text-indigo-600 dark:text-indigo-400 mx-auto mb-4" />
            <h3 className="text-xl font-semibold mb-2 dark:text-white">Open Limits</h3>
            <p className="text-gray-600 dark:text-slate-400">
          ...
          <div className="bg-white dark:bg-slate-800 p-6 rounded-xl shadow-lg">
            ...
            <h3 className="text-xl font-semibold mb-2 dark:text-white">Instant Revoke</h3>
            <p className="text-gray-600 dark:text-slate-400">
